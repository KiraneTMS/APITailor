   ...
   <body class="main-layout">
      ...
      <section class="container-header">
        ...
        <ul class="task-items">
            ...
            <li class="item type1">
                <div class="task">
                    <div class="name" style="width:150px"> &nbsp;&nbsp;&nbsp;&nbsp;Arsya Alifian </div>
                </div>
                ...
                <div class="dates">
                    <div class="bar"> &nbsp;&nbsp;&nbsp;&nbsp;22/05/2002 </div>
                </div>

                <div class="address">
                    <div class="bar"> &nbsp;&nbsp;&nbsp;&nbsp;Jl. Raya Binong No. 1 </div>
                </div>
            ...
            <li class="item type1">
                <div class="task">
                    <div class="name" style="width:150px"> &nbsp;&nbsp;&nbsp;&nbsp;Salman Fauzan </div>
                </div>
                ...
                <div class="dates">
                    <div class="bar"> &nbsp;&nbsp;&nbsp;&nbsp;21/04/2004 </div>
                </div>

                <div class="address">
                    <div class="bar"> &nbsp;&nbsp;&nbsp;&nbsp;Komp. Permata Kopo Blok C 67 </div>
                </div>
            ...
            <li class="item type1">
                <div class="task">
                    <div class="name" style="width:150px"> &nbsp;&nbsp;&nbsp;&nbsp;Audi Syahzehan </div>
                </div>

                <div class="status">
                    <div class="icon"> </div>
                    <div class="text"> true </div>
                </div>

                <div class="dates">
                    <div class="bar"> &nbsp;&nbsp;&nbsp;&nbsp;02/05/2002 </div>
                </div>

                <div class="address">
                    <div class="bar"> &nbsp;&nbsp;&nbsp;&nbsp;Jl. Terusan Buah Batu No.146 </div>
                </div>
            ...
            <li class="item type1">
                <div class="task">
                    <div class="name" style="width:150px"> &nbsp;&nbsp;&nbsp;&nbsp;Ammar Taradifa </div>
                </div>
                ...
                <div class="dates">
                    <div class="bar"> &nbsp;&nbsp;&nbsp;&nbsp;10/12/2003 </div>
                </div>

                <div class="address">
                    <div class="bar"> &nbsp;&nbsp;&nbsp;&nbsp;Komp. Cikoneng Prima Estate No 5 </div>
                </div>
            ...
            <li class="item type1">
                <div class="task">
                    <div class="name" style="width:150px"> &nbsp;&nbsp;&nbsp;&nbsp;Aurluna </div>
                </div>
